...
import { base_url, isValidURL } from "../url";
                ...
                >
                  ...
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        isValidURL(detail.img2)
                          ? detail.img2
                          : `${base_url}/${detail.img2}`
                      }
                      alt="..."
                    />
                  </div>
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        isValidURL(detail.img3)
                          ? detail.img3
                          : `${base_url}/${detail.img3}`
                      }
                      alt="..."
                    />
                  </div>
                  <div className="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
                    <img
                      className="w-100"
                      src={
                        isValidURL(detail.img4)
                          ? detail.img4
                          : `${base_url}/${detail.img4}`
                      }
                      alt="..."
                    />
                  </div>
